...
const controlSearchResults = async function() {
    try {
        _resultsViewJsDefault.default.renderSpiner();
        //1) Get search query
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        _addRecipeViewJsDefault.default.renderSpiner();
...
const updateServings = function(newServings) {
    ...
    //newQwt=oldQt*newServing/oldServings//2*8/4=4
    });
...
const KEY = '7ee81f38-a44b-4e79-9b59-e2ac887fbb66';
...
class RecipeView extends _viewJsDefault.default {
    ...
    _errorMessage = 'We could not finde the recipe, please try another one!';
    _message = '';
